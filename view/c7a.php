...
<body class="fix-header card-no-border">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <h4 class="card-title">Reporte Diario</h4>
                                ...
                                <div class="table-responsive m-t-40" id="listadoregistros">
                                    <table id="tablac7a" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Fecha</th>
                                                <th>Conductor</th>
    ...
    <!-- ======================================================= -->
    <script type="text/javascript" src="js/c7a.js"></script>
</body>
